...
const Login = () => {
  ...
  let data=JSON.parse(localStorage.getItem('ecom'))||[]
  console.log(data)
  const handleLogIn=()=>{
    let obj = {
  ...
  if(!obj.email && !obj.password){
    alert('palese enter all the Fields||')
  }
  let findName= data.find((ele)=>ele.email===obj.email)
  if(findName){
    if(findName.password===obj.password){
     Navigate('/')
    } 
    else{
          ...
          <form>
            ...
            <div>
              ...
              <div class="relative flex items-center">
                <input ref={emailRef} name="username" type="text" required class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter Email Address"></input>
            ...
            <div class="mt-4">
              ...
              <div class="relative flex items-center">
                <input ref={passwordRef} name="password" type="password" required class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter password" />
            ...
            <div class="mt-8">
              <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none" onClick={handleLogIn}>
                Log in
              </button>
            </div>
            <p class="text-sm mt-6 text-center text-gray-800">Don't have an account <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
          </form>
        </div>
      </div>
    </div>
