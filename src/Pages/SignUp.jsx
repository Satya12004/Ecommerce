  ...
  let navigate=useNavigate();
    ...
    const handleSubmit=()=>{
        ...
        if(obj.name && obj.email && obj.password){
          ...
          console.log(find)
          if(find){
           return alert('user allready registered')
          }
          else{
            // console.log(obj);
    ...
    <div>
      ...
      <div class="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
        ...
        <form class="md:col-span-2 w-full py-6 px-6 sm:px-16 max-md:max-w-xl mx-auto">
          ...
          <div class="space-y-6">
            <div>
              ...
              <div class="relative flex items-center">
                <input ref={nameRef} name="name" type="text" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter name" />
            ...
            <div>
              ...
              <div  class="relative flex items-center">
                <input ref={EmailRef} name="email" type="email" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter email" />
            ...
            <div>
              ...
              <div class="relative flex items-center">
                <input ref={PasswordRef} name="password" type="password" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter password" />
          ...
          <div class="mt-8">
            <button type="button" class="w-full py-2.5 px-4 tracking-wider text-sm rounded-md text-white bg-gray-700 hover:bg-gray-800 focus:outline-none"  onClick={handleSubmit}>
              Submit
            </button>
          </div>
