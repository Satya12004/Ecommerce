      ...
      <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link to='/cart'
              class='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Cart</Link>
            </li>
            ...
            <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link to='/contact'
